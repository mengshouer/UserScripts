  ...
  class StorageManager {
    ...
    loadSettings() {
      try {
        ...
        /* @__PURE__ */ console.debug("Failed to load settings:", error);
      }
    ...
    saveSettings(newSettings) {
      ...
      try {
        ...
        /* @__PURE__ */ console.debug("Failed to save settings:", error);
      }
    ...
    resetSettings() {
      try {
        ...
        /* @__PURE__ */ console.debug("Failed to reset settings:", error);
      }
      return { ...this.defaultSettings };
    }
  }
...
`;
  ...
  class MessageService {
    ...
    success(content, duration) {
      return this.show({ type: "success", content, ...duration !== void 0 && { duration } });
    }
    error(content, duration) {
      return this.show({ type: "error", content, ...duration !== void 0 && { duration } });
    }
    warning(content, duration) {
      return this.show({ type: "warning", content, ...duration !== void 0 && { duration } });
    }
    info(content, duration) {
      return this.show({ type: "info", content, ...duration !== void 0 && { duration } });
    }
    destroy() {
...
`;
  ...
  function useI18n() {
    ...
    const t2 = (key, fallback) => i18n.t(key, fallback);
    return { t: t2, locale, setLocale };
  }
...
`;
    ...
    return /* @__PURE__ */ u$3(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ u$3(Select, { value: locale, options: languages, onChange: handleLanguageChange })
        ]
      }
    );
  }
  ...
  function SettingsPanel({ isOpen, onClose }) {
    ...
    return /* @__PURE__ */ u$3(Modal, { isOpen, onClose, title: t2("title"), children: /* @__PURE__ */ u$3("div", { children: [
      ...
      /* @__PURE__ */ u$3("div", { style: sectionTitleStyle, children: t2("settings.image.title") }),
      /* @__PURE__ */ u$3("div", { style: fieldContainerStyle, children: [
        ...
        /* @__PURE__ */ u$3("div", { style: helpTextStyle, children: t2("settings.image.fileNameHelp") })
      ] }),
      ...
      /* @__PURE__ */ u$3("div", { style: sectionTitleStyle, children: t2("settings.video.title") }),
      /* @__PURE__ */ u$3("div", { style: fieldContainerStyle, children: [
        ...
        /* @__PURE__ */ u$3("div", { style: helpTextStyle, children: t2("settings.video.fileNameHelp") })
      ] }),
      /* @__PURE__ */ u$3("div", { style: fieldContainerStyle, children: /* @__PURE__ */ u$3(
        Checkbox,
        {
      ...
      /* @__PURE__ */ u$3("div", { style: sectionTitleStyle, children: t2("settings.universal.title") }),
      /* @__PURE__ */ u$3("div", { style: fieldContainerStyle, children: [
        /* @__PURE__ */ u$3(
          Checkbox,
          {
...
`;
  ...
  function extractMediaFromTweetData(tweetData) {
    try {
      ...
      for (const entry of timelineAddEntries.entries) {
        ...
        if (entryType === "TimelineTimelineItem" && itemContent?.itemType === "TimelineTweet" && itemContent.tweet_results?.result?.legacy?.extended_entities?.media) {
  ...
  function getTwitterHeaders() {
    ...
    if (!csrfToken || !cookies) {
      /* @__PURE__ */ console.debug("无法获取必要的认证信息");
      return null;
    }
    return {
      accept: "*/*",
    ...
    try {
      ...
      if (errors && errors.length > 0) {
        ...
        if (code === 139 && name === "AuthorizationError") {
          /* @__PURE__ */ console.debug(`📋 推文已点赞: ${tweetId}`);
          message.info("推文已点赞");
          return { success: true };
        }
      ...
      if (data?.favorite_tweet === "Done") {
        /* @__PURE__ */ console.debug(`✅ 成功点赞推文: ${tweetId}`);
        message.info("点赞成功");
        return { success: true };
      }
  ...
  function handleDownloadError(error, prefix = "下载失败") {
...
`;
  ...
  `;
    ...
    G(/* @__PURE__ */ u$3(UniversalDownloadButton, { tweetContainer: tweetElement }), buttonContainer);
