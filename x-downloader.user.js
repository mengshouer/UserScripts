...
(function() {
  "use strict";
  var n$3, l$4, u$4, t$4, i$4, r$3, o$4, e$3, f$4, c$4, s$4, a$4, h$3, p$4 = {}, v$2 = [], y$2 = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i, w$2 = Array.isArray;
  function d$3(n2, l2) {
  ...
  var t$2, r$2, u$2, i$2, o$2 = 0, f$2 = [], c$2 = l$4, e$2 = c$2.__b, a$2 = c$2.__r, v$1 = c$2.diffed, l$2 = c$2.__c, m$1 = c$2.unmount, s$2 = c$2.__;
  function p$2(n2, t2) {
  ...
  function x(n2) {
    var u2 = r$2.context[n2.__c], i2 = p$2(t$2++, 9);
  ...
  c$2.__b = function(n2) {
    ...
    })) : (i2.__h.forEach(z), i2.__h.forEach(B), i2.__h = [], t$2 = 0)), u$2 = r$2;
  ...
  let e$1 = { data: "" }, t$1 = (t2) => "object" == typeof window ? ((t2 ? t2.querySelector("#_goober") : window._goober) || Object.assign((t2 || document.head).appendChild(document.createElement("style")), { innerHTML: " ", id: "_goober" })).firstChild : t2 || e$1, r$1 = (e2) => {
    let r2 = t$1(e2), l2 = r2.data;
    return r2.data = "", l2;
  }, l$1 = /(?:([\u0080-\uFFFF\w-%@]+) *:? *([^{;]+?);|([^;}{]*?) *{)|(}\s*)/g, a$1 = /\/\*[^]*?\*\/|  +/g, n$1 = /\n+/g, o$1 = (e2, t2) => {
    let r2 = "", l2 = "", a2 = "";
    for (let n2 in e2) {
  ...
  function u$1(e2) {
    ...
    return i$1(l2.unshift ? l2.raw ? p$1(l2, [].slice.call(arguments, 1), r2.p) : l2.reduce((e3, t2) => Object.assign(e3, t2 && t2.call ? t2(r2.p) : t2), {}) : l2, t$1(r2.target), r2.g, r2.o, r2.k);
  }
  ...
  class StorageManager {
    ...
    loadSettings() {
      try {
        ...
        /* @__PURE__ */ console.log("Failed to load settings:", error);
      }
    ...
    saveSettings(newSettings) {
      ...
      try {
        ...
        /* @__PURE__ */ console.log("Failed to save settings:", error);
      }
    ...
    resetSettings() {
      try {
        ...
        /* @__PURE__ */ console.log("Failed to reset settings:", error);
      }
      return { ...this.defaultSettings };
    }
  }
...
`;
  function Modal({
    ...
    const handleCloseHover = (e2, isHover) => {
          ...
          /* @__PURE__ */ u$3("div", { style: headerStyle, children: [
            ...
            /* @__PURE__ */ u$3(
              "button",
              {
                ...
                onClick: onClose,
                onMouseEnter: (e2) => handleCloseHover(e2, true),
                onMouseLeave: (e2) => handleCloseHover(e2, false),
                children: "×"
              }
            )
          ] }),
...
`;
  ...
  function StyleEditor({ value, onChange }) {
    ...
    return /* @__PURE__ */ u$3("div", { children: [
      /* @__PURE__ */ u$3(
        "textarea",
        {
          style: textareaStyle,
      ...
      error && /* @__PURE__ */ u$3("div", { style: errorStyle, children: error })
    ] });
  }
  function SettingsPanel({ isOpen, onClose }) {
    ...
    return /* @__PURE__ */ u$3(Modal, { isOpen, onClose, title: "X(Twitter) Downloader 设置", children: /* @__PURE__ */ u$3("div", { children: [
      /* @__PURE__ */ u$3("div", { style: sectionTitleStyle, children: "图片下载设置" }),
      /* @__PURE__ */ u$3("div", { style: fieldContainerStyle, children: [
        /* @__PURE__ */ u$3("label", { style: labelStyle, children: "图片文件名格式" }),
        /* @__PURE__ */ u$3(
          Input,
          {
        ...
        /* @__PURE__ */ u$3("div", { style: helpTextStyle, children: "可用变量：<%Userid>、<%Tid>、<%Time>、<%PicName>、<%PicNo>" })
      ] }),
      /* @__PURE__ */ u$3("div", { style: fieldContainerStyle, children: /* @__PURE__ */ u$3(
        Checkbox,
        {
      ...
      /* @__PURE__ */ u$3("div", { style: fieldContainerStyle, children: [
        /* @__PURE__ */ u$3("label", { style: labelStyle, children: "图片下载按钮 CSS 样式属性" }),
        /* @__PURE__ */ u$3(
          StyleEditor,
          {
      ...
      /* @__PURE__ */ u$3("div", { style: sectionTitleStyle, children: "视频下载设置" }),
      /* @__PURE__ */ u$3("div", { style: fieldContainerStyle, children: [
        /* @__PURE__ */ u$3("label", { style: labelStyle, children: "视频文件名格式" }),
        /* @__PURE__ */ u$3(
          Input,
          {
        ...
        /* @__PURE__ */ u$3("div", { style: helpTextStyle, children: "可用变量：<%Userid>、<%Tid>、<%Time>" })
      ] }),
      /* @__PURE__ */ u$3("div", { style: fieldContainerStyle, children: /* @__PURE__ */ u$3(
        Checkbox,
        {
      ...
      /* @__PURE__ */ u$3("div", { style: fieldContainerStyle, children: [
        /* @__PURE__ */ u$3("label", { style: labelStyle, children: "视频下载按钮 CSS 样式属性" }),
        /* @__PURE__ */ u$3(
          StyleEditor,
          {
      ...
      /* @__PURE__ */ u$3("div", { style: buttonGroupStyle, children: /* @__PURE__ */ u$3(Button, { variant: "secondary", onClick: handleReset, children: "重置为默认设置" }) })
    ] }) });
  }
  function App() {
    ...
    return /* @__PURE__ */ u$3(k$1, { children: [
      /* @__PURE__ */ u$3(SettingsButton, { onClick: handleToggleSettings, isSettingsPanelOpen }),
      /* @__PURE__ */ u$3(SettingsPanel, { isOpen: isSettingsPanelOpen, onClose: handleCloseSettings })
    ] });
  }
  const spin = h$1`
  0% {
...
`;
  const defaultDownloadIcon = /* @__PURE__ */ u$3(DownloadIcon, { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", children: /* @__PURE__ */ u$3("path", { d: "M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z" }) });
  ...
  function extractMediaFromTweetData(tweetData) {
    try {
      ...
      for (const entry of timelineAddEntries.entries) {
        ...
        if (content.entryType === "TimelineTimelineItem" && content.itemContent && content.itemContent.itemType === "TimelineTweet" && content.itemContent.tweet_results?.result?.legacy?.extended_entities?.media) {
  ...
  const createButtonVisibilityHandlers = (buttonContainer, settingKey, rerenderCallback) => {
    const showButton = () => {
  ...
  function setupVideoInteraction(video) {
    ...
    let tweetContainer = video;
    while (tweetContainer && tweetContainer.tagName !== "BODY") {
      if (tweetContainer.tagName === "ARTICLE" && tweetContainer.getAttribute("data-testid") === "tweet") {
        break;
      }
