...
// @require     https://cdn.jsdelivr.net/npm/preact@10.29.8/dist/preact.umd.js
// @require     https://cdn.jsdelivr.net/npm/goober@2.1.19/dist/goober.umd.js
// @require     https://cdn.jsdelivr.net/npm/preact@10.29.8/jsx-runtime/dist/jsxRuntime.umd.js
// @require     https://cdn.jsdelivr.net/npm/preact@10.29.8/hooks/dist/hooks.umd.js
// @require     https://cdn.jsdelivr.net/npm/@preact/signals-core@1.14.4/dist/signals-core.min.js
// ==/UserScript==
  ...
  const i18n = {
    ...
    setLocale(locale) {
      if (currentLocale !== locale) {
        ...
        listeners$2.forEach((callback) => callback());
      }
    },
    getLocale() {
    ...
    t,
    subscribe(callback) {
      listeners$2.push(callback);
      return () => {
        const index = listeners$2.indexOf(callback);
        if (index > -1) listeners$2.splice(index, 1);
      };
    }
  };
  function useI18n() {
...
`;
  ...
  function GeneralSettingsCard({
    ...
    return /* @__PURE__ */ jsxRuntime2.jsxs(SettingsCard, { title: t2("common.generalSettings.title"), children: [
      /* @__PURE__ */ jsxRuntime2.jsxs("div", { style: fieldStyle, children: [
        /* @__PURE__ */ jsxRuntime2.jsx("label", { style: labelStyle, children: t2("common.messagePlacement.label") }),
        /* @__PURE__ */ jsxRuntime2.jsx(
          Select,
          {
            value: placement,
      ...
      /* @__PURE__ */ jsxRuntime2.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntime2.jsx("label", { style: labelStyle, children: t2("common.messageAlertDuration.label") }),
        /* @__PURE__ */ jsxRuntime2.jsx(
          Input,
          {
            value: alertDuration,
        ...
        /* @__PURE__ */ jsxRuntime2.jsx("div", { style: helpTextStyle, children: t2("common.messageAlertDuration.help") })
      ] })
    ] });
  }
  const NEXT_LOCALE = {
  ...
  function LanguageToggleButton() {
    ...
    return /* @__PURE__ */ jsxRuntime2.jsx(Button, { variant: "secondary", size: "small", onClick: () => setLocale(nextLocale), children: `🌐 ${LOCALE_LABELS[nextLocale]}` });
  }
...
`;
      ...
      ModalContainer,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime2.jsxs("div", { style: headerStyle, children: [
            ...
            /* @__PURE__ */ jsxRuntime2.jsxs("div", { style: { display: "flex", alignItems: "center", gap: "12px", flexShrink: 0 }, children: [
              headerActions,
              /* @__PURE__ */ jsxRuntime2.jsx(
                "button",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntime2.jsx(
                    "svg",
                    {
                      ...
                      strokeWidth: "2",
                      strokeLinecap: "round",
                      children: /* @__PURE__ */ jsxRuntime2.jsx("path", { d: "M6 6l12 12M18 6L6 18" })
                    }
                  )
                }
              )
  ...
  function ResetSettingsButton({ onReset }) {
    ...
    return /* @__PURE__ */ jsxRuntime2.jsx(Button, { variant: confirming ? "danger" : "secondary", onClick: handleClick, children: confirming ? t2("common.resetConfirm") : t2("common.resetSettings") });
  }
  ...
  const zhTranslations = {
    ...
    settings: {
      ...
      universal: {
        ...
        downloadOnManualLikeHelp: "手动点赞后自动下载推文中的图片或视频（无法确认点赞结果时仍会下载并提示）。按住 Shift 键点赞可临时禁用自动下载。",
        autoLikeApiFallback: "点赞失败时使用 API fallback",
        autoLikeApiFallbackHelp: "当无法监听到 X 原生点赞响应时，直接调用 FavoriteTweet API 重试。开启后可能增加机器人检测风险。",
  ...
  const enTranslations = {
    ...
    settings: {
      ...
      universal: {
        ...
        autoLikeHelp: "Automatically like the tweet when downloading images or videos. Automated likes may increase account risk.",
        downloadOnManualLike: "Download on manual like",
        downloadOnManualLikeHelp: "Automatically download tweet media after you manually like a tweet. If the like result cannot be confirmed, the download still proceeds with a notice. Hold Shift while clicking like to temporarily disable auto-download.",
        autoLikeApiFallback: "Use API fallback when auto-like fails",
        autoLikeApiFallbackHelp: "Directly calls the FavoriteTweet API when the native X like response cannot be observed. Enabling this may increase bot-detection risk.",
    ...
    messages: {
      ...
      manualLikeResponseUncertain: "Like response error for @{user}, download continued ({error}). Click to open the tweet",
      manualLikeResponseMissing: "@{user} like may not have gone through (no response observed), download continued. Click to open the tweet",
  ...
  function SettingsPanel({ isOpen, onClose }) {
    ...
    return /* @__PURE__ */ jsxRuntime2.jsx(
      Modal,
      {
        ...
        onClose,
        title: t2("title"),
        headerActions: /* @__PURE__ */ jsxRuntime2.jsx(LanguageToggleButton, {}),
        children: /* @__PURE__ */ jsxRuntime2.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntime2.jsx(
            GeneralSettingsCard,
            {
          ...
          /* @__PURE__ */ jsxRuntime2.jsxs(SettingsCard, { title: t2("settings.universal.title"), children: [
            ...
            /* @__PURE__ */ jsxRuntime2.jsxs("div", { style: { marginTop: "16px" }, children: [
              ...
              /* @__PURE__ */ jsxRuntime2.jsx("div", { style: helpTextStyle, children: t2("settings.universal.showFollowBadgeHelp") })
            ] }),
            /* @__PURE__ */ jsxRuntime2.jsxs("div", { style: { marginTop: "16px" }, children: [
              /* @__PURE__ */ jsxRuntime2.jsx(
                Checkbox,
                {
                  ...
                  children: t2("settings.universal.downloadOnManualLike")
                }
              ),
              /* @__PURE__ */ jsxRuntime2.jsx("div", { style: helpTextStyle, children: t2("settings.universal.downloadOnManualLikeHelp") })
            ] }),
            /* @__PURE__ */ jsxRuntime2.jsxs("div", { style: { marginTop: "16px" }, children: [
              /* @__PURE__ */ jsxRuntime2.jsx(
                Checkbox,
            ...
            /* @__PURE__ */ jsxRuntime2.jsxs("div", { style: { marginTop: "16px" }, children: [
              /* @__PURE__ */ jsxRuntime2.jsx(
                Checkbox,
                {
                  ...
                  children: t2("settings.universal.autoLikeApiFallback")
                }
              ),
              /* @__PURE__ */ jsxRuntime2.jsx("div", { style: helpTextStyle, children: t2("settings.universal.autoLikeApiFallbackHelp") })
            ] }),
            /* @__PURE__ */ jsxRuntime2.jsxs("div", { style: { marginTop: "16px" }, children: [
              /* @__PURE__ */ jsxRuntime2.jsx(
                Checkbox,
          ...
          /* @__PURE__ */ jsxRuntime2.jsx("div", { style: { display: "flex", justifyContent: "flex-end" }, children: /* @__PURE__ */ jsxRuntime2.jsx(
            ResetSettingsButton,
            {
              onReset: () => {
                resetSettings();
...
`;
  ...
  function getTweetIdFromElement(element, username = "") {
    ...
    while (current && current.tagName !== "BODY") {
      if (current.tagName === "ARTICLE" && current.hasAttribute("data-testid")) {
        ...
        if (testId === "tweet") {
          const statusLinkSelector = username ? `a[href*="${username}/status/"]` : 'a[href*="/status/"]';
          const links = current.querySelectorAll(statusLinkSelector);
  ...
  const isFavoriteTweetUrl = (url) => url.includes("/i/api/graphql/") && url.includes(FAVORITE_TWEET_OPERATION);
  const getString$1 = (value) => typeof value === "string" && value.length > 0 ? value : void 0;
  const readTweetIdFromPayload = (payload) => {
    if (!isRecord$1(payload)) {
      return void 0;
    }
    const variables = payload.variables;
    if (!isRecord$1(variables)) {
      return void 0;
    }
    return getString$1(variables.tweet_id);
  };
  const readTweetIdFromBodyText = (bodyText) => {
    if (!bodyText) {
      return void 0;
    }
    try {
  ...
  const getFetchBodyText = async (input, init) => {
  ...
  const notifyFavoriteTweetResult = (result) => {
  ...
  const parseFavoriteTweetResponse = (tweetId, payload, status) => {
    if (!isRecord$1(payload)) {
    ...
    const [error2] = response.errors ?? [];
    if (error2?.code === 139 && error2.name === "AuthorizationError") {
  ...
  const readFavoriteTweetFromText = (tweetId, responseText, status) => {
  ...
  const readFavoriteTweetFromResponseClone = (tweetId, responseClone) => {
    void responseClone.text().then((responseText) => readFavoriteTweetFromText(tweetId, responseText, responseClone.status)).catch((error2) => {
      console.warn("[x-downloader] FavoriteTweet response read failed:", error2);
      notifyFavoriteTweetResult({ tweetId, success: false, status: responseClone.status });
    });
  };
  const readFavoriteTweetFromXhr = (tweetId, xhr) => {
  ...
  const installFavoriteTweetResponseInterceptor = () => {
    const pageWindow = getPageWindow$1();
    const xhrBodies = /* @__PURE__ */ new WeakMap();
    const xhrInstances = /* @__PURE__ */ new WeakSet();
    ...
    pageWindow.fetch = ((...args) => {
      const requestUrl = getFetchUrl$1(args[0]);
      const tweetIdPromise = isFavoriteTweetUrl(requestUrl) ? getFetchBodyText(args[0], args[1]).then(readTweetIdFromBodyText) : void 0;
        ...
        void responsePromise.then(
          (response) => {
            ...
            return tweetIdPromise.then((tweetId) => {
              ...
              void responseClone.body?.cancel().catch(() => void 0);
            });
          },
          async (error2) => {
            const tweetId = await tweetIdPromise.catch(() => void 0);
            if (tweetId) {
              notifyFavoriteTweetResult({
                tweetId,
                success: false,
          ...
          console.warn("[x-downloader] FavoriteTweet interceptor failed:", error2);
        });
      }
      return responsePromise;
    });
    pageWindow.XMLHttpRequest.prototype.open = function openWithFavoriteTweetTracking(method, url, async, username, password) {
    ...
    pageWindow.XMLHttpRequest.prototype.send = function sendWithFavoriteTweetTracking(...args) {
  ...
  const subscribeFavoriteTweetResponse = (listener) => {
  ...
  const handleDocumentClick$1 = (event) => {
    const target = event.target;
  ...
  const initializeFollowBadgeSystem = () => {
    ...
    document.addEventListener("click", handleDocumentClick$1, true);
  ...
  const LIKE_RESPONSE_TIMEOUT_MS = 8e3;
  ...
  async function tryLikeViaDom(tweetContainer, tweetId) {
    ...
    const confirmedResult = !likeResult.success && likeResult.canUseApiFallback && tweetContainer.querySelector(UNLIKE_BUTTON_SELECTOR) ? { success: true, likedThisSession: true } : likeResult;
  ...
  function waitForFavoriteTweetResponse(tweetId) {
    let timeoutId;
    let unsubscribe;
    const cleanup = () => {
      if (timeoutId !== void 0) {
    ...
    const promise = new Promise((resolve) => {
      ...
      unsubscribe = subscribeFavoriteTweetResponse((result) => {
        ...
        const error2 = result.errorMessage || i18n.t("messages.likeResponseError");
        resolve({ success: false, message: error2 });
      });
    });
    return {
      promise,
  ...
  async function fallbackLikeViaApi(tweetId, { fallbackMessage }) {
  ...
  function checkMissingFields(fields, source) {
    const missing = [];
  ...
  async function downloadImageMedia({
    targetImage,
    tweetContainer,
    settings,
    imageIndex,
    ...
    try {
      ...
      const parseSource = window.location.href.includes("photo") ? window.location.href : firstA?.href || "";
      if (parseSource) {
  ...
  function findLightboxDisplayedImage(tweetContainer) {
    const imgCandidates = Array.from(
      tweetContainer.querySelectorAll(IMAGE_SELECTOR)
    ).filter((img) => !img.closest("article"));
    const videoCandidates = Array.from(
      tweetContainer.querySelectorAll(VIDEO_SELECTOR)
  ...
  async function downloadLightboxImage(tweetContainer, settings) {
    ...
    if (targetMedia instanceof HTMLVideoElement) {
      const downloaded2 = await downloadVideoMedia({
        src: targetMedia.src,
        tweetContainer,
        settings,
        showSuccessMessage: true
      });
      return downloaded2.success;
    }
  ...
  async function downloadLightboxVideo(tweetContainer, settings) {
    const video = Array.from(tweetContainer.querySelectorAll(VIDEO_SELECTOR)).find(
      (v) => !v.closest("article")
    );
  ...
  async function downloadTweetImages(images, tweetContainer, settings) {
    let hasFieldWarning = false;
  ...
  async function downloadTweetVideo(tweetContainer, videos, settings) {
  ...
  const handleImageDownload = async ({
    ...
    try {
      const downloadResult = await downloadImageMedia({
        targetImage,
        tweetContainer: tweetContainer || void 0,
        settings,
        isShiftPressed
      });
      if (downloadResult.success && settings.autoLikeOnDownload && downloadResult.tweetId && !isShiftPressed) {
...
`;
  ...
  const MANUAL_LIKE_RESPONSE_TIMEOUT_MS = 15e3;
  const MANUAL_LIKE_DOWNLOAD_COOLDOWN_MS = 1e4;
  const activeManualLikeTweetIds = /* @__PURE__ */ new Set();
  let initialized = false;
  const buildTweetUrl = (tweetId, username) => username ? `https://x.com/${username}/status/${tweetId}` : `https://x.com/i/web/status/${tweetId}`;
  const isStillUnliked = (tweetContainer) => {
  ...
  const watchLikeResult = (tweetId, username, tweetContainer) => {
    let settled = false;
    let timeoutId;
    let unsubscribe;
    const cleanup = () => {
    ...
    const warnWithTweetLink = (content) => {
      message.warning(
        content,
        void 0,
        void 0,
    ...
    unsubscribe = subscribeFavoriteTweetResponse((result) => {
      ...
      settle(
        result.success ? void 0 : { kind: "error", message: result.errorMessage || i18n.t("messages.likeResponseError") }
      );
    });
  };
  const maybeDownloadAfterManualLike = (tweetContainer, likeButton) => {
    const hasMedia = tweetHasDownloadableImages(tweetContainer) || tweetHasDownloadableVideos(tweetContainer);
    if (!hasMedia) {
      return;
    }
    const tweetId = getTweetIdFromElement(likeButton);
    const username = tweetId ? getUserIdFromTweetContainer(tweetContainer) : void 0;
    if (tweetId) {
    ...
    void (async () => {
      try {
        ...
        console.error("Download on manual like failed:", error2);
      } finally {
        if (tweetId) {
          window.setTimeout(
  ...
  const handleDocumentClick = (event) => {
    ...
    const likeButton = target.closest(LIKE_BUTTON_SELECTOR);
    if (!likeButton) {
      return;
    }
  ...
  const initializeManualLikeDownload = () => {
    if (initialized) {
      return;
    }
    initialized = true;
